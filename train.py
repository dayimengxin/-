...
from dataload import NormalDataset, BalancingClassDataset, WCNormalDataset
...
if __name__ == '__main__':
    ...
    train_dataset = WCNormalDataset(os.path.join(DATA_ROOT), INPUT_SIZE, INPUT_LIST, RGB_MEAN, RGB_STD)
    ...
    NUM_EPOCH_WARM_UP = NUM_EPOCH // 10  # use the first 1/25 epochs to warm up
